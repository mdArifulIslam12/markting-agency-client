...
const OutStandingUi4 = () => {
    return (
        <div data-aos="fade-left"
            data-aos-duration="500"
            data-aos-easing="ease-in" className="col-lg-12 outStandingUi-section outStandingUi-section-4 show" id='4'>
            <div className="row">
                <div className="col-lg-5 text-center h-100 my-auto img ">
                    <img src="https://wp.xpeedstudio.com/seocify/home-eighteen/wp-content/uploads/sites/30/2018/12/t4_icon_big.png" className='mt-3' alt="" />
                </div>
                <div className="col-lg-7 py-5 outstanding-ui-section-details pe-5 ">
                    ...
                    <button className='outstanding-button-section-4 mb-3'>Learn More</button>
                </div>
            </div>
        </div>
    );
