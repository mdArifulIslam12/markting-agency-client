...
const OutStandingUi5 = () => {
    return (
        <div data-aos="fade-left"
            ...
            data-aos-easing="ease-in" className="col-lg-12 outStandingUi-section outStandingUi-section-5 show" id='5'>
            <div className="row">
                <div className="col-lg-5 text-center h-100 my-auto img ">
                    <img src="https://wp.xpeedstudio.com/seocify/home-eighteen/wp-content/uploads/sites/30/2018/12/t5_icon_big-1.png" className='mt-3' alt="" />
                </div>
                <div className="col-lg-7 py-5 outstanding-ui-section-details pe-5 ">
                    <h3>Social Marketing</h3>
                    <p className='details mt-3'>
                        Expand your brand's reach and connect with your audience through social media marketing. Our tailored strategies drive engagement, build brand awareness, and generate leads, helping your business thrive in the digital landscape.</p>
                    ...
                    <button className='outstanding-button-section-5 mb-3'>Learn More</button>
                </div>
            </div>
        </div>
    );
